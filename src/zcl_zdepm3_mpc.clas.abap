class ZCL_ZDEPM3_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_FICATEGORY,
        IPCATEGORY type string,
    end of TS_FICATEGORY .
  types:
...
CLASS ZCL_ZDEPM3_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZDEPM3_SRV' ).
...
lo_action = model->create_action( 'FIcategory' ).  "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'IPcategory'    iv_abap_fieldname = 'IPCATEGORY' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZDEPM3_MPC=>TS_FICATEGORY' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZDEPM3_MPC=>TS_PRODUCT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250223084421'.                  "#EC NOTEXT
